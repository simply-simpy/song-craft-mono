...
export interface IMembershipRepository {
  ...
  findByUserAndAccount(userId: string, accountId: string): Promise<DbMembership | null>;
...
export interface IUserContextRepository {
  ...
  update(userId: string, data: UpdateUserContextData): Promise<DbUserContext | null>;
...
export class MembershipRepository implements IMembershipRepository {
  ...
  async findByUserAndAccount(userId: string, accountId: string): Promise<DbMembership | null> {
    const [membership] = await this.db
      .select()
      .from(memberships)
      .where(
  ...
  async update(id: string, data: UpdateMembershipData): Promise<DbMembership | null> {
...
export class UserContextRepository implements IUserContextRepository {
  ...
  async update(userId: string, data: UpdateUserContextData): Promise<DbUserContext | null> {
  ...
  async upsert(userId: string, data: CreateUserContextData): Promise<DbUserContext> {
