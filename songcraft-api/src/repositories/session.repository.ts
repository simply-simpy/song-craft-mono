...
import { sessions, users, projects, accounts } from "../schema";
...
export class SessionRepository implements ISessionRepository {
   ...
   */
  private buildOrderBy(sort: SessionPaginationOptions["sort"], order: "asc" | "desc") {
   ...
   */
  private serializeSession(session: any): SessionWithDetails {
    return {
      id: session.id,
  ...
  async findMany(pagination: SessionPaginationOptions): Promise<SessionWithDetails[]> {
