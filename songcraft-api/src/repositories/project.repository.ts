...
import { projects, users, accounts, sessions } from "../schema";
...
export class ProjectRepository implements IProjectRepository {
   ...
   */
  private buildOrderBy(sort: ProjectPaginationOptions["sort"], order: "asc" | "desc") {
   ...
   */
  private serializeProject(project: any): ProjectWithDetails {
    return {
      id: project.id,
