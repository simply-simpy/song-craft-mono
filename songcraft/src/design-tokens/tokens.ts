...
export type ColorTokens = keyof SemanticTokens['bg'] | keyof SemanticTokens['fg'] | keyof SemanticTokens['surface'] | keyof SemanticTokens['border'] | keyof SemanticTokens['brand'];
