      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 bg-bg-primary border border-border-primary rounded">bg-primary</div>
            <div className="p-4 bg-bg-secondary border border-border-primary rounded">bg-secondary</div>
            <div className="p-4 bg-bg-brand text-fg-on-brand border border-border-primary rounded">bg-brand</div>
          </div>
        </section>
      </div>
    </div>
